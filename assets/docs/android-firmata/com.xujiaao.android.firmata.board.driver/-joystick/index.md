[android-firmata](../../index.md) / [com.xujiaao.android.firmata.board.driver](../index.md) / [Joystick](./index.md)

# Joystick

`interface Joystick : `[`Peripheral`](../../com.xujiaao.android.firmata.board/-peripheral/index.md)

### Properties

| Name | Summary |
|---|---|
| [x](x.md) | `abstract val x: `[`Float`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html) |
| [y](y.md) | `abstract val y: `[`Float`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html) |

### Functions

| Name | Summary |
|---|---|
| [startUpdating](start-updating.md) | `abstract fun startUpdating(callback: `[`Joystick`](./index.md)`.(x: `[`Float`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html)`, y: `[`Float`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html)`) -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)` = null): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html) |
...
| Name | Summary |
|---|---|
| [DefaultJoystick](../-default-joystick/index.md) | `class DefaultJoystick : `[`BasePeripheral`](../../com.xujiaao.android.firmata.board/-base-peripheral/index.md)`, `[`Joystick`](./index.md) |
